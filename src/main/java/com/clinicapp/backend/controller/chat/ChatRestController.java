...
public class ChatRestController {
    ...
    public ResponseEntity<Page<ChatMessageDTO>> getAllMessages(
        ...
        User currentUser = (User) authentication.getPrincipal();
        return ResponseEntity.ok(chatMessageService.getMessagesForUser(currentUser.getId(), pageable));
    }
    ...
    @Operation(summary = "Get all available chat participants", 
              description = "Returns users (doctors and secretaries, excluding current user) who can be messaged")
